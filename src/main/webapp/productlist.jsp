      ...
      <div id="sidebar-menu" class="sidebar-menu">
        ...
        <ul>
          <li class="submenu">
            ...
            <ul>
              <li><a href="productlist.jsp" class="active">Danh sách sản phẩm</a></li>
  ...
  <div class="page-wrapper">
    <div class="content">
      <div class="page-header">
        ...
        <div class="page-btn">
          <a href="addproduct.jsp" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img" class="me-1">Thêm sản phẩm mới</a>
        </div>
      </div>
          ...
          <div class="table-responsive">
            <table class="table datanew">
              ...
              <tr>
                ...
                <td>Admin</td>
                <td>
                  <a class="me-3" href="product-details.jsp">
                    <img src="assets/img/icons/eye.svg" alt="img">
                  </a>
                  <a class="me-3" href="editproduct.jsp">
