...
import DatabaseModel.StatisticDTO;
...
public class StatisticController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("index2".equals(page)) {
            ...
            List<List<Object>> datas = StatisticDTO.getRevenueAndSalesByCategoryByYear(2024);
            List<Object> categories = datas.get(0);
            List<Object> revenues = datas.get(1);
            List<Object> sales = datas.get(2);
            ...
            // Chuyển tiếp đến trang index3.jsp
            request.setAttribute("availableYears", availableYears);
