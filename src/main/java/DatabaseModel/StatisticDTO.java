...
public class StatisticDTO {
    ...
    public static List<List<Integer>> getDeliveredAndCanceledData(int year) {
        ...
        try {
            ...
            TypedQuery<Object[]> query = entityManager.createQuery(jpql, Object[].class);
            query.setParameter("year", year);
            query.setParameter("delivered", OrderStatus.DELIVERED);  // So sánh với enum
            query.setParameter("canceled", OrderStatus.CANCELED);  // So sánh với enum
    ...
    public static List<Order> getCompletedAndCanceledOrders(int year) {
        ...
        try {
            ...
            query.setParameter("year", year);
            query.setParameter("delivered", OrderStatus.DELIVERED);  // Trạng thái đã hoàn thành
            query.setParameter("canceled", OrderStatus.CANCELED);  // Trạng thái đã hủy
    ...
    public static List<Order> getDeliveredOrCanceledOrders() {
        ...
        try {
            ...
            TypedQuery<Order> query = entityManager.createQuery(jpql, Order.class);
            query.setParameter("delivered", OrderStatus.DELIVERED);  // Trạng thái đã giao
            query.setParameter("canceled", OrderStatus.CANCELED);  // Trạng thái đã hủy
