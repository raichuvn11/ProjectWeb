    ...
    <div class="content">
      <div class="page-header">
        <div class="page-title">
          ...
          <h6>Cập nhật sản phẩm của bạn</h6>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="form-group">
                <label>Mô tả</label>
                <textarea class="form-control">Lorem Ipsum là văn bản giả dùng trong ngành in ấn và dàn trang, nó đã trở thành tiêu chuẩn ngành từ những năm 1500.</textarea>
              </div>
            </div>
            <div class="col-lg-12">
              <div class="form-group">
            ...
            <div class="col-lg-12">
              <a href="javascript:void(0);" class="btn btn-submit me-2">Cập nhật</a>
